...
[← Back to Meet the Team]({{ "/meet_the_team" | relURL }})   \|   [Meet John]({{ "/john_doe" | relURL }}) \| [Meet Jane]({{ "/jane_smith" | relURL }}) \| [Meet Bob]({{ "/bob_johnson" | relURL }}) \| [Meet Alice]({{ "/alice_lee" | relURL }})
